<h2><a href="https://www.geeksforgeeks.org/problems/largest-bst/1?page=1&sortBy=submissions">Largest BST</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a binary tree. Find the size of its largest subtree that is a Binary Search Tree.<br>
